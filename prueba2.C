...
//Ahora todos los Arcos
  ...
  graph.insert_arc(M155,M159,162.00);
  ...
  graph.insert_arc(M157,M158,238.00);
  graph.insert_arc(M158,M157,238.00);
  graph.insert_arc(M158,M160,427.5);
  graph.insert_arc(M158,M161,176.08);
  graph.insert_arc(M159,M155,162.00);
...
int counter = 0;
  ...
  dijkstra.compute_min_paths_tree(graph,M1, dijkstra_test); //Ejecuto el codigo dijkstra para el grafo "graph", empezando en M1 y guardando el arbol abarcados en el dijkstra_test
